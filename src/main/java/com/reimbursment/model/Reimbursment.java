...
public class Reimbursment {
	...
	public Reimbursment(String reimbursementId, String projectName, Date date, String officeLocation,
			String reimType, String receiptId, Date receiptDate,
			String conveyanceDetails, String timeIn, String timeOut,
			String amount, String status, String empComments,
			String appliedManager, String mgrComments) {
		super();
	...
	public String toString() {
		return "Reimbursment [reimbursementId=" + reimbursementId
				+ ", projectName=" + projectName + ", date=" + date
				+ ", officeLocation=" + officeLocation + ", reimType="
				+ reimType + ", receiptId=" + receiptId + ", receiptDate="
				+ receiptDate + ", conveyanceDetails=" + conveyanceDetails
				+ ", timeIn=" + timeIn + ", timeOut=" + timeOut + ", amount="
				+ amount + ", status=" + status + ", empComments="
				+ empComments + ", appliedManager=" + appliedManager
				+ ", mgrComments=" + mgrComments + "]";
	}
